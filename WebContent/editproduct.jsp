...
<li><a href='additem'>AddMerchandise</a>  </li>
</ul>
</div>
 <div class='form-group' >
  <form action='editproduct2.jsp' method='post'  >
  <label for="Productname">ProductName:</label>
    <input type="text" name="productname" required value='<%=p.getProductname()%>' placeholder="Your product name.."/>
  
    <label for="productquantity">ProductQuantity:</label> <br>
    <input type="text"  name="productquantity" required value='<%=p.getProductquantity()%>'  placeholder="Your product quantity.."/>

    <label for="productprice">ProductPrice:</label> <br>
    <input type="text" name="productprice" required value='<%=p.getProductprice()%>'  placeholder="Your product price.."/> <br>
       <label for="ProductType">ProductType:</label> <br>
      
    <input type="text" name="producttype" required value='<%=p.getProducttype()%>'  placeholder="Yourproduct type.."/>
    <br>
...
<br>
  ...
  <input type='file' name='productimage' value='<%=p.getProductimage()%>'   required/> <br>  
