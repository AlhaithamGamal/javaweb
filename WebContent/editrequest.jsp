...
<li><a href='additem.jsp'>AddMerchandise</a>  </li>
</ul>
</div>
 <div class='form-group' >
  <form action='editrequest2.jsp' method='post'  >
  <label for="RequestID:">RequestID:</label> <br>
    ...
    <input type="text" name="productprice" required readonly value='<%=t.getProductprice()%>' readonly/> <br>
    ...
    <input type="text" name="quantitywanted" required value='<%=t.getQuantitywanted()%>' onkeyup="myFunction()"  />
     ...
     <input type="text" name="totalprice"  required value='<%=t.getTotalprice()%>'  />
